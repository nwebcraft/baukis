...
ActiveRecord::Schema.define(version: 20170124141808) do
  ...
  add_index "messages", ["customer_id", "deleted", "status", "created_at"], name: "index_messages_on_customer_id_del_stat_created_at", using: :btree
